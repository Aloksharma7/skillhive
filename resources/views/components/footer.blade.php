...
x
                        <a href="#" class="text-gray-400 hover:text-white hover:scale-110 transition-all duration-300">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M22.23 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.21 0 22.23 0zM7.27 20.1H3.65V9.24h3.62V20.1zM5.47 7.76h-.03c-1.22 0-2.01-.83-2.01-1.87 0-1.06.82-1.87 2.05-1.87 1.23 0 2.01.81 2.04 1.87 0 1.04-.81 1.87-2.05 1.87zM20.34 20.1h-3.63v-5.8c0-1.45-.52-2.45-1.83-2.45-1 0-1.6.67-1.87 1.32-.1.23-.11.55-.11.88v6.05H9.28s.05-9.82 0-10.84h3.63v1.54a3.6 3.6 0 0 1 3.26-1.8c2.37 0 4.15 1.55 4.15 4.89v6.21h.02z"/>
                            </svg>
                        </a>
                    </div>
                </div>
                ...
                <!-- Contact Section -->
                <div class="space-y-6">
                    <h3 class="text-xl font-semibold text-white border-b border-gray-700 pb-3">Get in Touch</h3>
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4 group">
                            <div class="bg-gray-800 p-2 rounded-lg group-hover:bg-blue-600 transition-colors duration-300">
                            ...
                            <span class="text-gray-300 group-hover:text-white transition-colors duration-300">hello@example.com</span>
                        </div>
                        <div class="flex items-center space-x-4 group">
                            <div class="bg-gray-800 p-2 rounded-lg group-hover:bg-blue-600 transition-colors duration-300">
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-300 group-hover:text-white transition-colors duration-300">+1 (555) 123-4567</span>
                        </div>
                        <div class="flex items-center space-x-4 group">
                            <div class="bg-gray-800 p-2 rounded-lg group-hover:bg-blue-600 transition-colors duration-300">
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-300 group-hover:text-white transition-colors duration-300">123 Main Street, City, State</span>
                        </div>
                    </div>
                </div>
            </div>
